export const projects = [
  {
    ...
    },
    {
      ...
      date: "2021",
      description: "A CLI app built with NodeJS. A simple quiz for your friends to see how well they know you.",
      liveLink: "https://replit.com/@blueanchovy/fromEx12?embed=1&output=1#index.js",
      sourceLink: "https://github.com/blueanchovy/quiz-do-you-know-Manish"
    },
    {
      name: "Do You know Raj Comics?",
      date: "2021",
      description: "A CLI app built with NodeJS. A quiz to check your knowledge of Raj Comics superheroes.",
    ...
    },
    {
      ...
      date: "2021",
      description: "An English to Pig-Latin translator, which takes the first consonant (or consonant cluster) of an English word, moves it to the end of the word and suffixes an ay.",
    ...
    },
    {
      ...
      date: "2021",
      description: "A movie recommendation app built with ReactJS. A compendium of movies that I like, sortable by genre.",
    ...
    },
    {
      ...
      date: "2021",
      description: "A cash register manager which helps the user by telling how can he/she return the change to the customer with the minimum number of notes.",
    ...
    },
    {
      ...
      date: "2021",
      description: "A website which can help you check whether your birthday is lucky or not by checking if the sum of its digits is divisible by your lucky number.",
    ...
    },
    {
      ...
      date: "29th September, 2021",
      description: "An App which checks whether your birthday is a palindrome birthday or not. If not, it gives the nearest upcoming palindrome date.",
